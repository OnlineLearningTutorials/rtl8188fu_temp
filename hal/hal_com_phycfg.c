...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - rtw_regsty_get_target_tx_power");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - rtw_regsty_chk_target_tx_power_valid");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetTxPowerByRateBase");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_SetTxPowerByRateBase");
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(Adapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_get_target_tx_power");
	struct registry_priv *regsty = adapter_to_regsty(Adapter);
	s16 target_power;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_StoreTxPowerByRateBaseOld");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_StoreTxPowerByRateBase");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetRateSectionIndexOfTxPowerByRate");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA( pAdapter );
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetRateValuesOfTxPowerByRate");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA( pAdapter );
	PDM_ODM_T		pDM_Odm = &pHalData->odmpriv;
	u8	 			index = 0, i = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_StoreTxPowerByRateNew");
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(pAdapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_StoreTxPowerByRateOld");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(pAdapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_InitTxPowerByRate");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(pAdapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_StoreTxPowerByRate");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(pAdapter);
	PDM_ODM_T  		pDM_Odm = &pHalData->odmpriv;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ConvertTxPowerByRateByBase");
	s8	i = 0;
	u8	TempValue = 0;
	u32	TempData = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_ConvertTxPowerByRateInDbmToRelativeValuesOld");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA( pAdapter );
	u8			base = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ConvertTxPowerByRateInDbmToRelativeValues");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA( pAdapter );
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_TxPowerByRateConfiguration");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA( pAdapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_SetTxPowerIndexByRateSection");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_GetChnlIndex");
	u8  i = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetTxPowerIndexBase");
	PHAL_DATA_TYPE		pHalData = GET_HAL_DATA(pAdapter);
	PDM_ODM_T			pDM_Odm = &pHalData->odmpriv;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetTxPowerTrackingOffset");
	PHAL_DATA_TYPE		pHalData = GET_HAL_DATA(pAdapter);
	PDM_ODM_T			pDM_Odm = &pHalData->odmpriv;	
	s8	offset = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetRateIndexOfTxPowerByRate");
	u8	index = 0;
	switch ( Rate )
	{
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - _PHY_GetTxPowerByRate");
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(pAdapter);
	s8 value = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetTxPowerByRate");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_SetTxPowerByRate");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA( pAdapter );
	u8	rateIndex = PHY_GetRateIndexOfTxPowerByRate( Rate );
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_SetTxPowerLevelByPath");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_SetTxPowerIndexByRateArray");
	u32	powerIndex = 0;
	int	i = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_GetWorldWideLimit");
	s8	min = LimitTable[0];
	u8	i = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_GetChannelIndexOfTxPowerLimit");
	s8	channelIndex = -1;
	u8	i = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetTxPowerLimit");
	HAL_DATA_TYPE		*pHalData = GET_HAL_DATA(Adapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_CrossReferenceHTAndVHTTxPowerLimit");
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(pAdapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_ConvertTxPowerLimitToPowerIndex");
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(Adapter);
	u8 base;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_SetTxPowerLimit");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_GetTxPowerIndex");
	u8	txPower = 0x3E;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_SetTxPowerIndex");
	if (IS_HARDWARE_TYPE_8814A(pAdapter)) {
#if (RTL8814A_SUPPORT == 1)
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_is_tx_power_limit_needed");
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_is_tx_power_by_rate_needed");
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
	struct registry_priv *regsty = dvobj_to_regsty(adapter_to_dvobj(adapter));
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_load_tx_power_by_rate");
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
	struct registry_priv *regsty = dvobj_to_regsty(adapter_to_dvobj(adapter));
	int ret = _FAIL;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_load_tx_power_limit");
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
	struct registry_priv *regsty = dvobj_to_regsty(adapter_to_dvobj(adapter));
	int ret = _FAIL;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_load_tx_power_ext_info");
	struct registry_priv *regsty = adapter_to_regsty(adapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_reload_tx_power_ext_info");
	phy_load_tx_power_ext_info(adapter, 1);
}

inline void phy_reload_default_tx_power_ext_info(_adapter *adapter)
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_reload_default_tx_power_ext_info");
	phy_load_tx_power_ext_info(adapter, 0);
}

void dump_tx_power_ext_info(void *sel, _adapter *adapter)
{
	printk(KERN_DEBUG "hal_com_phycfg.c - dump_tx_power_ext_info");
	struct registry_priv *regsty = adapter_to_regsty(adapter);
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - dump_target_tx_power");
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
	struct registry_priv *regsty = adapter_to_regsty(adapter);
	int path, tx_num, band, rs;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - dump_tx_power_by_rate");
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - dump_tx_power_limit");
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
	struct registry_priv *regsty = dvobj_to_regsty(adapter_to_dvobj(adapter));
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - rtw_get_phy_file_path");
#ifdef CONFIG_LOAD_PHY_PARA_FROM_FILE
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	int len = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ConfigMACWithParaFile");
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(Adapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ConfigBBWithParaFile");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(Adapter);
	int	rlen = 0, rtStatus = _FAIL;
	char	*szLine, *ptmp;
	u32	u4bRegOffset, u4bRegValue, u4bMove;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_DecryptBBPgParaFile");
	u32	i = 0, j = 0;
	u8	map[95] = {0};
	u8	currentChar;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ParseBBPgParaFile");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ConfigBBWithPgParaFile");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(Adapter);
	int	rlen = 0, rtStatus = _FAIL;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ConfigBBWithMpParaFile");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(Adapter);
	int	rlen = 0, rtStatus = _FAIL;
	char	*szLine, *ptmp;
	u32	u4bRegOffset, u4bRegValue, u4bMove;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_ConfigRFWithParaFile");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(Adapter);
	int	rlen = 0, rtStatus = _FAIL;
	char	*szLine, *ptmp;
	u32	u4bRegOffset, u4bRegValue, u4bMove;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - initDeltaSwingIndexTables");
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_ConfigRFWithTxPwrTrackParaFile");
	HAL_DATA_TYPE		*pHalData = GET_HAL_DATA(Adapter);
	PDM_ODM_T			pDM_Odm = &pHalData->odmpriv;
	PODM_RF_CAL_T  		pRFCalibrateInfo = &(pDM_Odm->RFCalibrateInfo);
	int	rlen = 0, rtStatus = _FAIL;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_ParsePowerLimitTableFile");
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(Adapter);
	PDM_ODM_T	pDM_Odm = &(pHalData->odmpriv);
	u32	i = 0, forCnt = 0;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - PHY_ConfigRFWithPowerLimitTableParaFile");
	HAL_DATA_TYPE		*pHalData = GET_HAL_DATA(Adapter);
	int	rlen = 0, rtStatus = _FAIL;
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_free_filebuf_mask");
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(padapter);
...
{
	printk(KERN_DEBUG "hal_com_phycfg.c - phy_free_filebuf");
