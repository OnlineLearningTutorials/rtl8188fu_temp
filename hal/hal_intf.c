...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_chip_configure");
	padapter->HalFunc.intf_chip_configure(padapter);
}

void rtw_hal_read_chip_info(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_read_chip_info");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_read_chip_version");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_def_value_init");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_data_init");
	if (is_primary_adapter(padapter)) {
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_data_deinit");
	if (is_primary_adapter(padapter)) {
		if (padapter->HalData) 
		{
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_free_data");
	//free HAL Data 	
	rtw_hal_data_deinit(padapter);	
}
void rtw_hal_dm_init(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_dm_init");
	if (is_primary_adapter(padapter)) {
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_dm_deinit");
	if (is_primary_adapter(padapter)) {
		PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(padapter);		
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sw_led_init");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sw_led_deinit");
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_power_on");
	return padapter->HalFunc.hal_power_on(padapter);
}
void rtw_hal_power_off(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_power_off");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_init_opmode");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_init");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_deinit");
	uint	status = _SUCCESS;
	struct dvobj_priv *dvobj = adapter_to_dvobj(padapter);
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(padapter);
	int i;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_hwreg");
	padapter->HalFunc.SetHwRegHandler(padapter, variable, val);
}

void rtw_hal_get_hwreg(_adapter *padapter, u8 variable, u8 *val)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_get_hwreg");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_hwreg_with_buf");
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_def_var");
	return padapter->HalFunc.SetHalDefVarHandler(padapter,eVariable,pValue);
}
u8 rtw_hal_get_def_var(_adapter *padapter, HAL_DEF_VARIABLE eVariable, PVOID pValue)
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_get_def_var");
	return padapter->HalFunc.GetHalDefVarHandler(padapter,eVariable,pValue);		
}	

void rtw_hal_set_odm_var(_adapter *padapter, HAL_ODM_VARIABLE eVariable, PVOID pValue1,BOOLEAN bSet)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_odm_var");
	padapter->HalFunc.SetHalODMVarHandler(padapter,eVariable,pValue1,bSet);
}
void	rtw_hal_get_odm_var(_adapter *padapter, HAL_ODM_VARIABLE eVariable, PVOID pValue1,PVOID pValue2)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_get_odm_var");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_enable_interrupt");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_disable_interrupt");
#if defined(CONFIG_PCI_HCI) || defined (CONFIG_SDIO_HCI) || defined (CONFIG_GSPI_HCI)
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_check_ips_status");
	u8 val = _FALSE;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_fw_dl");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_inirp_init");
	if (is_primary_adapter(padapter)) 		
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_inirp_deinit");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_irp_reset");
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_intf_ps_func");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_xmitframe_enqueue");
	return padapter->HalFunc.hal_xmitframe_enqueue(padapter, pxmitframe);
}

s32	rtw_hal_xmit(_adapter *padapter, struct xmit_frame *pxmitframe)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_xmit");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_mgnt_xmit");
	s32 ret = _FAIL;
	u8	*pframe, subtype;
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_init_xmit_priv");
	return padapter->HalFunc.init_xmit_priv(padapter);	
}
void	rtw_hal_free_xmit_priv(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_free_xmit_priv");
	padapter->HalFunc.free_xmit_priv(padapter);
}

s32	rtw_hal_init_recv_priv(_adapter *padapter)
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_init_recv_priv");
	return padapter->HalFunc.init_recv_priv(padapter);
}
void	rtw_hal_free_recv_priv(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_free_recv_priv");
	padapter->HalFunc.free_recv_priv(padapter);
}

void rtw_hal_update_ra_mask(struct sta_info *psta, u8 rssi_level)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_update_ra_mask");
	_adapter *padapter;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_add_ra_tid");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_start_thread");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_stop_thread");
#if defined(CONFIG_SDIO_HCI) || defined (CONFIG_GSPI_HCI)
#ifndef CONFIG_SDIO_TX_TASKLET
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_read_bbreg");
	u32 data = 0;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_write_bbreg");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_read_rfreg");
	u32 data = 0;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_write_rfreg");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_interrupt_handler");
	s32 ret = _FAIL;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_bwmode");
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(padapter);
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_chan");
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(padapter);
	PDM_ODM_T		pDM_Odm = &(pHalData->odmpriv);
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_chnl_bw");
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(padapter);
	PDM_ODM_T		pDM_Odm = &(pHalData->odmpriv);
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_set_tx_power_level");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_get_tx_power_level");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_dm_watchdog");
	if (!is_primary_adapter(padapter))
		return;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_dm_watchdog_in_lps");
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_bcn_related_reg_setting");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_hostap_mgnt_xmit_entry");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sreset_init");
	padapter->HalFunc.sreset_init_value(padapter); 
}
void rtw_hal_sreset_reset(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sreset_reset");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sreset_reset_value");
	padapter->HalFunc.sreset_reset_value(padapter);
}

void rtw_hal_sreset_xmit_status_check(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sreset_xmit_status_check");
	if (!is_primary_adapter(padapter))
		return;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sreset_linked_status_check");
	if (!is_primary_adapter(padapter))
		return;
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sreset_get_wifi_status");
	return padapter->HalFunc.sreset_get_wifi_status(padapter);
}

bool rtw_hal_sreset_inprogress(_adapter *padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_sreset_inprogress");
	padapter = GET_PRIMARY_ADAPTER(padapter);
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_iol_cmd");
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_xmit_thread_handler");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_notch_filter");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_c2h_valid");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_c2h_evt_read");
	HAL_DATA_TYPE *HalData = GET_HAL_DATA(adapter);
	HAL_VERSION *hal_ver = &HalData->VersionID;
	s32 ret = _FAIL;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_c2h_handler");
	s32 ret = _FAIL;
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_c2h_id_filter_ccx");
	return adapter->HalFunc.c2h_id_filter_ccx;
}

s32 rtw_hal_is_disable_sw_channel_plan(PADAPTER padapter)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_is_disable_sw_channel_plan");
	return GET_HAL_DATA(padapter)->bDisableSWChannelPlan;
}

s32 rtw_hal_macid_sleep(PADAPTER padapter, u8 macid)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_macid_sleep");
	struct dvobj_priv *dvobj = adapter_to_dvobj(padapter);
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_macid_wakeup");
	struct dvobj_priv *dvobj = adapter_to_dvobj(padapter);
	struct macid_ctl_t *macid_ctl = dvobj_to_macidctl(dvobj);
	u8 support;
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_fill_h2c_cmd");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_fill_fake_txdesc");
	padapter->HalFunc.fill_fake_txdesc(padapter, pDesc, BufferLen,IsPsPoll, IsBTQosNull, bDataFrame);

}
u8 rtw_hal_get_txbuff_rsvd_page_num(_adapter *adapter, bool wowlan)
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_get_txbuff_rsvd_page_num");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_update_hisr_hsisr_ind");
...
{
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_fw_correct_bcn");
...
{	
	printk(KERN_DEBUG "hal_intf.c - rtw_hal_ops_check");
	u8 ret = _SUCCESS;
#if 1
	/*** initialize section ***/
