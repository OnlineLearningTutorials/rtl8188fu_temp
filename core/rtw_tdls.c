...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_reset_tdls_info");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_init_tdls_info");
	int	res = _SUCCESS;
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_free_tdls_info");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - check_ap_tdls_prohibited");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - check_ap_tdls_ch_switching_prohibited");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_is_setup_allowed");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_is_chsw_allowed");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _issue_nulldata_to_TDLS_peer_STA");
	int ret = _FAIL;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_nulldata_to_TDLS_peer_STA");
	int ret;
	int i = 0;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - free_tdls_sta");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_key");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_process_ht_cap");
	struct mlme_ext_priv	*pmlmeext = &padapter->mlmeextpriv;
	struct mlme_ext_info	*pmlmeinfo = &(pmlmeext->mlmext_info);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_ht_cap");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_process_vht_cap");
	struct mlme_priv		*pmlmepriv = &padapter->mlmepriv;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_aid");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_vht_cap");
	u32 ie_len = 0;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_vht_operation");
	u32 ie_len = 0;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_vht_op_mode_notify");
	u32 ie_len = 0;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_sup_ch");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_rsnie");
	u8 *p = NULL;
	int len = 0;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_ext_cap");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_qos_cap");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_ftie");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_timeout_interval");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_bss_coexist");
	u8 iedata=0;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_capability");
	struct mlme_ext_priv	*pmlmeext = &padapter->mlmeextpriv;
	struct mlme_ext_info	*pmlmeinfo = &pmlmeext->mlmext_info;
	u8 cap_from_ie[2] = {0};
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_supported_rate");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_sup_reg_class");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_linkid");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_target_ch");
	u8 target_ch = 1;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_ch_sw");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_ch_sw_oper_control");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_ch_sw_back_to_base_chnl");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_chsw_oper_init");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_chsw_oper_wait");
	struct submit_ctx	*chsw_sctx = &padapter->tdlsinfo.chsw_info.chsw_sctx;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_chsw_oper_done");
	struct submit_ctx	*chsw_sctx = &padapter->tdlsinfo.chsw_info.chsw_sctx;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_do_ch_sw");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_set_wmm_params");
	struct mlme_ext_priv	*pmlmeext = &(padapter->mlmeextpriv);	
	struct mlme_ext_info	*pmlmeinfo = &(pmlmeext->mlmext_info);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_process_wfd_ie");
	u8 *wfd_ie;
	u32	wfd_ielen = 0;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tunneled_probe_req");
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv			*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tunneled_probe_rsp");
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv			*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_setup_req");
	struct tdls_info	*ptdlsinfo = &padapter->tdlsinfo;
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _issue_tdls_teardown");
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv			*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_teardown");
	int ret = _FAIL;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_dis_req");
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv			*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_setup_rsp");
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct xmit_priv			*pxmitpriv = &(padapter->xmitpriv);
	int ret = _FAIL;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_setup_cfm");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct xmit_priv			*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_dis_rsp");
	struct xmit_frame		*pmgntframe;
	struct pkt_attrib		*pattrib;
	unsigned char			*pframe;
	struct rtw_ieee80211_hdr	*pwlanhdr;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_peer_traffic_rsp");
	struct xmit_frame	*pmgntframe;
	struct pkt_attrib	*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv	*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_peer_traffic_indication");
	struct xmit_frame			*pmgntframe;
	struct pkt_attrib			*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv			*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_ch_switch_req");
	struct xmit_frame	*pmgntframe;
	struct pkt_attrib	*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv	*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - issue_tdls_ch_switch_rsp");
	struct xmit_frame	*pmgntframe;
	struct pkt_attrib	*pattrib;
	struct mlme_priv	*pmlmepriv = &padapter->mlmepriv;
	struct xmit_priv	*pxmitpriv = &(padapter->xmitpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Dis_Rsp");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Setup_Req");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
	u8 *psa, *pmyid;
	struct sta_info *ptdls_sta= NULL;
   	struct sta_priv *pstapriv = &padapter->stapriv;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Setup_Rsp");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Setup_Cfm");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
	struct sta_info *ptdls_sta= NULL;
   	struct sta_priv *pstapriv = &padapter->stapriv;
	u8 *ptr = precv_frame->u.hdr.rx_data;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Dis_Req");
	struct rx_pkt_attrib	*prx_pkt_attrib = &precv_frame->u.hdr.attrib;
	struct sta_priv *pstapriv = &padapter->stapriv;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Teardown");
	u8 *psa;
	u8 *ptr = precv_frame->u.hdr.rx_data;
	struct rx_pkt_attrib	*prx_pkt_attrib = &precv_frame->u.hdr.attrib;
	struct mlme_ext_priv	*pmlmeext = &(padapter->mlmeextpriv);	
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Peer_Traffic_Indication");
	struct rx_pkt_attrib	*pattrib = &precv_frame->u.hdr.attrib;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Peer_Traffic_Rsp");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
	struct mlme_ext_priv *pmlmeext = &padapter->mlmeextpriv;
	struct rx_pkt_attrib	*pattrib = & precv_frame->u.hdr.attrib;
	struct sta_priv *pstapriv = &padapter->stapriv;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Ch_Switch_Req");
	struct tdls_ch_switch *pchsw_info = &padapter->tdlsinfo.chsw_info;
	struct sta_info *ptdls_sta= NULL;
   	struct sta_priv *pstapriv = &padapter->stapriv;
	u8 *ptr = precv_frame->u.hdr.rx_data;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - On_TDLS_Ch_Switch_Rsp");
	struct tdls_ch_switch *pchsw_info = &padapter->tdlsinfo.chsw_info;
	struct sta_info *ptdls_sta= NULL;
   	struct sta_priv *pstapriv = &padapter->stapriv;
	u8 *ptr = precv_frame->u.hdr.rx_data;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - wfd_ie_tdls");
	struct mlme_priv		*pmlmepriv = &padapter->mlmepriv;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_setup_req_ies");
	struct registry_priv	*pregistrypriv = &padapter->registrypriv;
	struct mlme_ext_priv	*pmlmeext = &(padapter->mlmeextpriv);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_setup_rsp_ies");
	struct registry_priv	*pregistrypriv = &padapter->registrypriv;
	struct mlme_ext_priv	*pmlmeext = &(padapter->mlmeextpriv);
	struct pkt_attrib	*pattrib = &pxmitframe->attrib;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_setup_cfm_ies");
	struct registry_priv	*pregistrypriv = &padapter->registrypriv;
	struct mlme_ext_priv	*pmlmeext = &(padapter->mlmeextpriv);
	struct mlme_ext_info	*pmlmeinfo = &(pmlmeext->mlmext_info);
	struct pkt_attrib	*pattrib = &pxmitframe->attrib;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_teardown_ies");
	struct pkt_attrib	*pattrib = &pxmitframe->attrib;
	struct sta_info *ptdls_sta = rtw_get_stainfo( &(padapter->stapriv) , pattrib->dst);
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_dis_req_ies");
	struct pkt_attrib *pattrib = &pxmitframe->attrib;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_dis_rsp_ies");
	struct registry_priv	*pregistrypriv = &padapter->registrypriv;
	struct mlme_ext_priv	*pmlmeext = &padapter->mlmeextpriv;
	struct pkt_attrib	*pattrib = &pxmitframe->attrib;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_peer_traffic_indication_ies");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_peer_traffic_rsp_ies");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_ch_switch_req_ies");
	struct tdls_info *ptdlsinfo = &padapter->tdlsinfo;
	struct pkt_attrib	*pattrib = &pxmitframe->attrib;
	struct sta_priv 	*pstapriv = &padapter->stapriv;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tdls_ch_switch_rsp_ies");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tunneled_probe_req_ies");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_build_tunneled_probe_rsp_ies");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _tdls_tpk_timer_hdl");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _tdls_ch_switch_timer_hdl");
	struct sta_info *ptdls_sta = (struct sta_info *)FunctionContext;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _tdls_delay_timer_hdl");
	struct sta_info *ptdls_sta = (struct sta_info *)FunctionContext;
	_adapter *padapter = ptdls_sta->padapter;
	struct tdls_ch_switch *pchsw_info = &padapter->tdlsinfo.chsw_info;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _tdls_stay_on_base_chnl_timer_hdl");
	struct sta_info *ptdls_sta = (struct sta_info *)FunctionContext;
	_adapter *padapter = ptdls_sta->padapter;
	struct tdls_ch_switch *pchsw_info = &padapter->tdlsinfo.chsw_info;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _tdls_ch_switch_monitor_timer_hdl");
	struct sta_info *ptdls_sta = (struct sta_info *)FunctionContext;
	_adapter *padapter = ptdls_sta->padapter;
	struct tdls_ch_switch *pchsw_info = &padapter->tdlsinfo.chsw_info;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _tdls_handshake_timer_hdl");
	struct sta_info *ptdls_sta = (struct sta_info *)FunctionContext;
	_adapter *padapter = ptdls_sta->padapter;
	struct tdls_txmgmt txmgmt;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - _tdls_pti_timer_hdl");
	struct sta_info *ptdls_sta = (struct sta_info *)FunctionContext;
	_adapter *padapter = ptdls_sta->padapter;
	struct tdls_txmgmt txmgmt;
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_init_tdls_timer");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_free_tdls_timer");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - update_sgi_tdls");
	return query_ra_short_GI(psta);
}

u32 update_mask_tdls(_adapter *padapter, struct sta_info *psta)
{
	printk(KERN_DEBUG "rtw_tdls.c - update_mask_tdls");
...
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_is_driver_setup");
	return padapter->tdlsinfo.driver_setup;
}

const char * rtw_tdls_action_txt(enum TDLS_ACTION_FIELD action)
{
	printk(KERN_DEBUG "rtw_tdls.c - rtw_tdls_action_txt");
	switch (action) {
